...
// Feature: Real Time
// Description: Real-time royalty settlement (platform DSP feeds)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Real Time. Real-time royalty settlement (platform DSP feeds)' },
