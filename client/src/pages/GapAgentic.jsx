...
// Agentic
// Agentic rights clearance traversing samples and rights holders
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic rights clearance traversing samples and rights holders</p>
