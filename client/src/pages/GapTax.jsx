...
// Tax
// Tax document generation (1099, foreign withholding)

export default function GapTax() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-tax', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Tax</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Tax document generation (1099, foreign withholding)</p>
