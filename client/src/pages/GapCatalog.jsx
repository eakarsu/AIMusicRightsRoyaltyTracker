...
// Catalog
// Catalog acquisition advisor producing investment theses

export default function GapCatalog() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-catalog', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Catalog</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Catalog acquisition advisor producing investment theses</p>
